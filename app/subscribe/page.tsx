  ...
  return (
    <div style={{ minHeight: "100vh", background: "#081418", display: "flex", alignItems: "center", justifyContent: "center", padding: "80px 24px", fontFamily: "'Inter',-apple-system,BlinkMacSystemFont,sans-serif" }}>
      ...
      <div style={{ width: "100%", maxWidth: 660 }}>
        ...
        <h1 style={{ fontSize: 34, fontWeight: 900, color: "#F5F7FA", letterSpacing: "-1.5px", marginBottom: 8 }}>Get AcademyOS</h1>
        <p style={{ fontSize: 15, color: "#97A6B2", marginBottom: 36 }}>Choose your plan and get started today. Secured by Stripe.</p>

        {/* Info form */}
        <div style={{ background: "#0b1a20", border: "1px solid rgba(255,255,255,.08)", borderRadius: 18, padding: 26, marginBottom: 22 }}>
          <p style={{ fontSize: 11, fontWeight: 700, color: "#97A6B2", textTransform: "uppercase", letterSpacing: ".1em", marginBottom: 16 }}>Your Information</p>
        ...
        <div className="sub-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: 14, marginBottom: 24 }}>
          ...
          <div style={{ background: "#0b1a20", border: "1px solid rgba(255,255,255,.08)", borderRadius: 18, padding: 26 }}>
            <p style={{ fontSize: 11, fontWeight: 700, color: "#97A6B2", textTransform: "uppercase", letterSpacing: ".1em", marginBottom: 4 }}>One-time</p>
            <h2 style={{ fontSize: 20, fontWeight: 900, color: "#F5F7FA", marginBottom: 4 }}>Custom Setup</h2>
            <div style={{ marginBottom: 20 }}>
              <span style={{ fontSize: 34, fontWeight: 900, color: "#F5F7FA", letterSpacing: "-1px" }}>$10k</span>
              <span style={{ fontSize: 13, color: "#97A6B2", marginLeft: 6 }}>once</span>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: 9, marginBottom: 22 }}>
              {["Full system setup & config","Player database import","Branding & custom domain","Full team training","30-day support"].map(f => (
            ...
            <button onClick={() => checkout("setup")} disabled={!!loading}
              ...
              {loading === "setup" ? "Redirecting…" : "Pay $10,000 →"}
            </button>
          </div>
          ...
          <div style={{ background: "#0f2318", border: "1px solid rgba(31,107,69,.3)", borderRadius: 18, padding: 26, position: "relative", boxShadow: "0 0 40px rgba(31,107,69,.08)" }}>
            <div style={{ position: "absolute", top: -12, left: 20, background: "#FFD447", color: "#081418", fontSize: 11, fontWeight: 800, padding: "4px 14px", borderRadius: 100, letterSpacing: ".06em" }}>POPULAR</div>
            <p style={{ fontSize: 11, fontWeight: 700, color: "#18B3A4", textTransform: "uppercase", letterSpacing: ".1em", marginBottom: 4 }}>Monthly</p>
            <h2 style={{ fontSize: 20, fontWeight: 900, color: "#F5F7FA", marginBottom: 4 }}>Academy License</h2>
            <div style={{ marginBottom: 20 }}>
              <span style={{ fontSize: 34, fontWeight: 900, color: "#F5F7FA", letterSpacing: "-1px" }}>$4k</span>
              <span style={{ fontSize: 13, color: "#97A6B2", marginLeft: 6 }}>/month</span>
            </div>
            <div style={{ display: "flex", flexDirection: "column", gap: 9, marginBottom: 22 }}>
              {["Unlimited players & coaches","Automated billing & invoicing","Parent email portal","Full revenue analytics","Priority support","New features included"].map(f => (
                <div key={f} style={{ display: "flex", alignItems: "center", gap: 10, fontSize: 13, color: "#97A6B2" }}>
            ...
            <button onClick={() => checkout("subscription")} disabled={!!loading}
              ...
              {loading === "subscription" ? "Redirecting…" : "Subscribe $4,000/mo →"}
            </button>
          </div>
        </div>
